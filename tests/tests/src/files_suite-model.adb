...
package body Files_Suite.Model is
   ...
   begin
      ...
      Result := Files.Controller.Handle_Key (Model, Settings, Files.Types.Key_A, Ctrl);
      ...
      Files.Model.Set_Filter (Model, "");
      Result := Files.Controller.Handle_Key (Model, Settings, Files.Types.Key_I, Ctrl);
      ...
      Files.Model.Select_All_Visible (Model);
      Result := Files.Controller.Handle_Key (Model, Settings, Files.Types.Key_A, Ctrl_Shift);

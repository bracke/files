...
package body Files_Suite.Model is
   ...
   begin
      ...
      Assert
        (Repository_File_Contains
           ("src/files-file_system-available_root_entries.adb", "function Is_Mount_Container")
         and then Repository_File_Contains
           ("src/files-file_system-available_root_entries.adb", "return not Is_Mount_Container"),

...
package body Files.File_System is
   ...
   function Default_Thumbnail_Cache_Directory
     (Fallback_Directory : String)
      return String
     renames Files.File_System.Thumbnails.Default_Thumbnail_Cache_Directory;
   ...
   function Thumbnail_Path_For
     (Source_Path      : String;
      ...
      Size            : Positive := 64)
      return String
     renames Files.File_System.Thumbnails.Thumbnail_Path_For;
   ...
   function Generate_Thumbnail
     ...
     renames Files.File_System.Thumbnails.Generate_Thumbnail;

   function Decode_Image_To_Pixels
     (Path     : String;
      Max_Size : Positive)
      return Decoded_Image
     renames Files.File_System.Thumbnails.Decode_Image_To_Pixels;
   ...
   function Is_Image_Item
     (Kind     : Files.Types.Item_Kind;
      ...
      Icon_Id  : String)
      return Boolean
     renames Files.File_System.Thumbnails.Is_Image_Item;

   function Read_Preview_Text
     (Path      : String;
      Max_Bytes : Natural)
      return String
     renames Files.File_System.Thumbnails.Read_Preview_Text;
   ...
   function Load_Directory
     ...
     renames Files.File_System.Directory.Load_Directory;

   function Load_Item
     (Full_Path : String;
      Settings  : Files.Settings.Settings_Model)
      return Item_Load_Result
     renames Files.File_System.Directory.Load_Item;
   ...
   function Directory_Size
     ...
     renames Files.File_System.Directory.Directory_Size;
   ...
   function Make_Item
     ...
     renames Files.File_System.Directory.Make_Item;
